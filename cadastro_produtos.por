programa {
  funcao inicio() {
      ...
      //formula: total = qtd adquirida * preco
       ...
       escreva("informe qual é o valor do produto (ex: 7999.99): " )
       leia(precoProd)
      ...
      se(qtdProd <= 5){
        ...
        escreva("o valor total do produto é de: " + precoProd)
        escreva("\nvoce recebeu um desconto de 2% e o produto sairá por: " + desconto)
      ...
      senao se(qtdProd > 5 e qtdProd <= 10){
        ...
        escreva("o valor total do produto é de: " + precoProd)
        escreva("\nvoce recebeu um desconto de 3% e o produto sairá por: " + desconto)
      ...
      senao se(qtdProd > 10){
        ...
        escreva("o valor total do produto é de: " + precoProd)
        escreva("\nvoce recebeu um desconto de 5% e o produto sairá por: " + desconto) 
